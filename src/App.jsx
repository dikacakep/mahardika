...
import ZAINFIX from './assets/images/dika.png';
      ...
      <NavbarProvider>
        <div className="relative min-h-screen bg-[#060010] overflow-hidden">
          <div className="absolute inset-0 z-0">
            <Squares speed={0.3} squareSize={35} direction="diagonal" borderColor="rgba(255, 255, 255, 0.03)" hoverFillColor="rgba(0, 153, 255, 0.2)" />
          </div>
          ...
          <button
            ...
            className={`fixed top-24 right-4 z-50 p-3 rounded-full border backdrop-blur-sm transition-all duration-300 ease-in-out hover:scale-110
              ${is3dEnabled
                ? 'bg-[#0099ff]/20 border-[#0099ff] text-[#0099ff] shadow-[0_0_12px_2px_#0099ff80]'
          ...
          <main className="relative z-10 px-8 max-w-7xl mx-auto">
            <section id="home" className="flex flex-col md:flex-row items-center gap-10 pt-20 pb-16 lg:pt-0 lg:pb-20">
              <div className="flex-1 text-white space-y-6 pt-16 md:pt-40 order-last md:order-none">
                ...
                <motion.h1 initial={{ opacity: 0, x: -60 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, delay: 0.25, ease: "easeOut" }} className="text-4xl md:text-4xl font-moderniz font-bold leading-tight select-none" style={{ color: "#0099ff", textShadow: `2px 2px 0 #000754, 4px 4px 0 #4079ff, 0 4px 12px #0099ff, 0 1px 0 #0099ff` }}>
                    WELCOME TO MY
                ...
                <motion.div initial={{ opacity: 0, x: 60 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, delay: 0.4, ease: "easeOut" }}>
                    <GradientText colors={["#0099ff", "#4079ff", "#0099ff", "#4079ff", "#0099ff"]} animationSpeed={3} className="custom-class font-cascadia font-bold" />
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 1.0, ease: "easeOut" }} className="flex flex-row gap-4 mt-8">
                    <a href="https://github.com/mahardikarms" target="_blank" rel="noopener noreferrer" aria-label="GitHub Profile" className="group relative flex h-12 w-12 items-center justify-center rounded-full border border-slate-700 bg-slate-900/[0.8] text-white transition-all duration-300 hover:border-[#0099ff] hover:bg-slate-800 hover:shadow-[0_0_24px_2px_#0099ff]">
                        <FaGithub className="h-6 w-6 text-slate-400 transition-all duration-300 group-hover:text-[#0099ff]" />
                    </a>
                    <a href="https://instagram.com/mahardikarms" target="_blank" rel="noopener noreferrer" aria-label="Instagram Profile" className="group relative flex h-12 w-12 items-center justify-center rounded-full border border-slate-700 bg-slate-900/[0.8] text-white transition-all duration-300 hover:border-[#0099ff] hover:bg-slate-800 hover:shadow-[0_0_24px_2px_#0099ff]">
                        <FaInstagram className="h-6 w-6 text-slate-400 transition-all duration-300 group-hover:text-[#0099ff]" />
                    </a>
                    <a href="https://linkedin.com/in/mahardikarms" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile" className="group relative flex h-12 w-12 items-center justify-center rounded-full border border-slate-700 bg-slate-900/[0.8] text-white transition-all duration-300 hover:border-[#0099ff] hover:bg-slate-800 hover:shadow-[0_0_24px_2px_#0099ff]">
                        <FaLinkedin className="h-6 w-6 text-slate-400 transition-all duration-300 group-hover:text-[#0099ff]" />
                    </a>
                </motion.div>
              </div>
            ...
            >
              <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.8, ease: "easeOut" }} className="text-center">
                    <div className="relative flex w-full flex-col items-center justify-center overflow-hidden mb-20">
                        <VelocityScroll defaultVelocity={3} numRows={1} className="max-w-full">
                            <span className="font-moderniz font-bold" style={{ fontSize: "2.5rem", lineHeight: "1.1", color: "#0099ff", textShadow: "2px 2px 0 #000754, 4px 4px 0 #4079ff, 0 4px 12px #0099ff, 0 1px 0 #0099ff", background: "none", WebkitBackgroundClip: "unset", WebkitTextFillColor: "unset", animation: "none"}}>
                    ...
                    <p className="text-lg text-[#0099ff]/70 mt-2 font-cascadia px-1 mb-20">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center">
                ...
                >
                  <p className="text-2xl text-gray-300 font-moderniz my" style={{ textShadow: "2px 2px 0 #000754, 4px 4px 0 #4079ff, 0 4px 12px #0099ff, 0 1px 0 #0099ff" }}>Hello, I'm</p>
                  <h3 className="text-4xl font-bold text-white my-2 font-moderniz" style={{ textShadow: "2px 2px 0 #000754, 4px 4px 0 #4079ff, 0 4px 12px #0099ff, 0 1px 0 #0099ff" }}>Mahardika Ramadan Siregar</h3>
                  ...
                  <div className="my-6 bg-slate-900/50 border-l-4 border-[#0099ff] p-4 rounded-r-lg italic text-white/70 font-cascadia">
                  ...
                  <div className="flex flex-row sm:flex-row gap-4 mt-8 justify-center md:justify-start items-center">
                    <ButtonMovingBorder as="a" href="/cv.pdf" download duration={3000} borderRadius="0.75rem" className="bg-slate-900/[0.8] border border-slate-800 text-white font-semibold flex items-center justify-center gap-2 transition-all duration-300 hover:shadow-[0_0_24px_8px_#0099ff]">
                      <FaDownload /> Download CV
                    </ButtonMovingBorder>
                    <ButtonMovingBorder as="a" href="#projects" duration={3000} borderRadius="0.75rem" className="bg-slate-900/[0.8] border border-slate-800 text-white font-semibold flex items-center justify-center gap-2 transition-all duration-300 hover:shadow-[0_0_24px_8px_#0099ff]">
              ...
              <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.8, ease: "easeOut", delay: 0.4 }} className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mt-10 px-4 md:px-0">
                {stats.map((stat, index) => (
                  <div key={index} className="group relative p-6 rounded-2xl bg-gradient-to-br from-slate-900/80 to-slate-950/70 border border-slate-800/80 shadow-lg transition-all duration-300 hover:border-[#0099ff]/50 hover:shadow-[0_0_24px_0px_#0099ff50] cursor-pointer">
                    <div className="flex justify-between items-start">
                      <div className="flex flex-col">
                        <div className="p-3 mb-4 rounded-full bg-slate-800/80 border border-slate-700/60 w-max group-hover:bg-[#0099ff]/10 group-hover:border-[#0099ff]/50 transition-all duration-300">
                          <div className="text-2xl text-slate-400 group-hover:text-[#0099ff] transition-colors duration-300">{stat.icon}</div>
                        </div>
                      ...
                      <div className="flex flex-col items-end">
                        <p className="text-5xl font-bold text-white transition-all duration-300 group-hover:text-[#0099ff]">{stat.value}</p>
                        <FaArrowRight className="text-slate-600 mt-auto group-hover:text-[#0099ff] transition-all duration-300 -rotate-45" />
                      </div>
                    </div>
                  </div>
                ))}
